...
class Guerreiro : public Personagem {
    ...
    public:    
        ...
        // Habilidade de malhar. Quando utilizada o Guerreiro irá perder 4 de mana e ganhar 4 de ataque. Atualiza as variáveis de ataque e mana
        void malhar() {
            ataque +=  4;
            mana -= 4;
        }

        //Ataca o monstro. Chama a função de perder vida passando como parâmetro o objeto da classe Monstro
    ...
    while (reconhece == false){
        ...
        else if (opcao == "Guerreiro.") 
        {
            ...
            while (vivo == true) { //enquanto o personagem ainda esteja vivo podera tomar decisoes
                    ...
                    if(mVivo == true) // caso o monstro esteja vivo, sera possivel atacá-lo
                    {
